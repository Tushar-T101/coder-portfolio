...
const Hero = () => {
  ...
  return (
    <section id="hero" className={`min-h-screen flex items-center px-8 md:px-16 lg:px-24 ${
      ...
      <div className="w-full max-w-6xl mx-auto">
        {viewMode === 'coder' ? (
          ...
          <div className="flex flex-col justify-center max-w-4xl">
            ...
            >
              <h2 className="text-xl md:text-2xl font-medium text-blue-600 mb-4">Hello, I'm</h2>
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl">
                ...
                Specializing in Generative AI, Cloud Architecture, and creating tools that 
                bridge the gap between complex technology and user needs.
              </p>
              ...
              <div className="flex gap-6 text-gray-500">
                <a href="https://github.com/Tushar-T101" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 transition-colors">
                  <FaGithub size={24} />
                </a>
                <a href="https://www.linkedin.com/in/tushar-tugnait" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">
                  <FaLinkedin size={24} />
                </a>
                <a href="mailto:tushar.tugnait02@gmail.com" className="hover:text-red-500 transition-colors">
                  <FaEnvelope size={24} />
                </a>
              </div>
            </motion.div>
